...
async def api_generate():
    ...
    if stream:
        ...
        if final_chunk is None:
            # Handle the empty stream scenario appropriately for your frontend
            return quart.jsonify({"error": "No response generated by the model"}), 500
